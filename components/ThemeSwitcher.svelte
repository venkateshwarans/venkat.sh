<script>
  import {setTheme} from '../store/theme.js'
  let isToggled = false;
  const handleClick = () => {
    isToggled = !isToggled;
		setTheme(isToggled)
...
<div class="svelte-toggle" on:click={handleClick} class:svelte-toggle--checked={isToggled} class:svelte-toggle--focus={isToggled}>
  <div class="svelte-toggle-track">
    <div class="svelte-toggle-track-check">
      <img
        ...
        width="16" height="16" role="presentation" style="pointer-events: none;">
      </div>
    <div class="svelte-toggle-track-x">
      <img
  ...
  <input bind:checked={isToggled} class="svelte-toggle-screenreader-only" type="checkbox"
...
<style>
    .svelte-toggle {
            ...
            .svelte-toggle-screenreader-only {
                border: 0;
                clip: rect(0 0 0 0);
                height: 1px;
                margin: -1px;
            ...
            .svelte-toggle--checked .svelte-toggle-track-check,.svelte-toggle-track-x {
                opacity: 1;
                -webkit-transition: opacity .25s ease;
                transition: opacity .25s ease
            }

            .svelte-toggle-track-x {
                position: absolute;
                width: 17px;
                height: 17px;
                right: 5px;
            ...
            .svelte-toggle--checked .svelte-toggle-track-x {
                opacity: 0
            }
            ...
            .svelte-toggle:active .svelte-toggle-thumb {
